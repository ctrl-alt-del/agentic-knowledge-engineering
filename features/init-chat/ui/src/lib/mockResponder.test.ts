...
describe('MockResponder', () => {
  ...
  it('returns a non-empty string', async () => {
    const response = await responder.sendMessage([{ id: '0', role: 'user' as const, content: 'hello', timestamp: '2026-07-01 00:00:00' }])
  ...
  it('returns a response within 300-1500ms', async () => {
    ...
    await responder.sendMessage([{ id: '0', role: 'user' as const, content: 'hello', timestamp: '2026-07-01 00:00:00' }])
  ...
  it('returns responses that vary across calls', async () => {
    const msg: Message[] = [{ id: '0', role: 'user', content: 'x', timestamp: '2026-07-01 00:00:00' }]
